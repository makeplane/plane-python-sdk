...
@pytest.fixture
def estimate(proj: Any) -> Iterator[Any]:
...
class TestEstimatesCrud:
    def test_list_and_retrieve(self, proj: Any, estimate: Any) -> None:
    ...
    def test_update_only_touches_given_fields(self, proj: Any, estimate: Any) -> None:
    ...
    def test_sparse_fields_leave_others_none(self, proj: Any, estimate: Any) -> None:
...
class TestEstimatesUpsert:
    def test_upsert_creates_then_reconciles(self, proj: Any) -> None:
...
class TestEstimatesBulk:
    def test_bulk_create_update_delete(self, proj: Any) -> None:
...
class TestEstimateExpandPoints:
    def test_expand_points_inlines_the_points_list(self, proj: Any, estimate: Any) -> None:
...
class TestEstimatePointsCrud:
    def test_crud(self, proj: Any, estimate: Any) -> None:
    ...
    def test_upsert_creates_then_reconciles(self, proj: Any, estimate: Any) -> None:
    ...
    def test_bulk_create_update_delete(self, proj: Any, estimate: Any) -> None:
