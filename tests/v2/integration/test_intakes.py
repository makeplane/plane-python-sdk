...
@pytest.fixture
def intake_work_item(proj: Project) -> Iterator[Any]:
...
def test_list(proj: Project) -> None:
    page = proj.intakes.list()
    assert isinstance(page.data, list)


def test_create_retrieve_delete(proj: Project, intake_work_item: Any) -> None:
...
def test_patch_folds_the_status_transition(proj: Project, intake_work_item: Any) -> None:
