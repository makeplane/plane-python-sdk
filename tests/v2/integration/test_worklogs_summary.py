...
class TestProjectWorklogsSummary:
    def test_summary_reflects_a_logged_worklog(self, proj: Any, work_item: Any) -> None:
    ...
    def test_summary_on_a_project_with_no_worklogs_is_empty_list(self, proj: Any) -> None:
