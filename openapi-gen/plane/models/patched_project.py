...
from pydantic import BaseModel, StrictBool, StrictFloat, StrictInt, StrictStr, conint, constr
...
class PatchedProject(BaseModel):
    ...
    identifier: Optional[constr(strict=True, max_length=12)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedProject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedProject:
        """Create an instance of PatchedProject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedProject.parse_obj(obj)

        _obj = PatchedProject.parse_obj({
