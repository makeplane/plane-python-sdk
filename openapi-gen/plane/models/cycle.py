...
class Cycle(BaseModel):
    ...
    completed_estimates: Union[StrictFloat, StrictInt] = Field(...)
    ...
    started_estimates: Union[StrictFloat, StrictInt] = Field(...)
    started_issues: StrictInt = Field(...)
    timezone: Optional[TimezoneEnum] = None
    total_estimates: Union[StrictFloat, StrictInt] = Field(...)
