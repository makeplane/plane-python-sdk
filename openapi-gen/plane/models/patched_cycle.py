...
from pydantic import BaseModel, StrictFloat, StrictInt, StrictStr, conint, constr
from plane.models.timezone_enum import TimezoneEnum

class PatchedCycle(BaseModel):
    """
    PatchedCycle
    """
    ...
    __properties = ["archived_at", "backlog_issues", "cancelled_issues", "completed_estimates", "completed_issues", "created_at", "created_by", "deleted_at", "description", "end_date", "external_id", "external_source", "id", "logo_props", "name", "owned_by", "progress_snapshot", "project", "sort_order", "start_date", "started_estimates", "started_issues", "timezone", "total_estimates", "total_issues", "unstarted_issues", "updated_at", "updated_by", "version", "view_props", "workspace"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedCycle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedCycle:
        """Create an instance of PatchedCycle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedCycle.parse_obj(obj)

        _obj = PatchedCycle.parse_obj({
