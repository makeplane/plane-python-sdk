...
class PatchedModule(BaseModel):
    ...
    __properties = ["archived_at", "backlog_issues", "cancelled_issues", "completed_issues", "created_at", "created_by", "deleted_at", "description", "description_html", "description_text", "external_id", "external_source", "id", "lead", "logo_props", "members", "name", "project", "sort_order", "start_date", "started_issues", "status", "target_date", "total_issues", "unstarted_issues", "updated_at", "updated_by", "view_props", "workspace"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedModule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedModule:
        """Create an instance of PatchedModule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedModule.parse_obj(obj)

        _obj = PatchedModule.parse_obj({
