...
from pydantic import BaseModel, StrictBool, StrictBytes, StrictFloat, StrictInt, StrictStr, conint, conlist, constr
from plane.models.priority_enum import PriorityEnum

class PatchedIssue(BaseModel):
    """
    PatchedIssue
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedIssue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedIssue:
        """Create an instance of PatchedIssue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedIssue.parse_obj(obj)

        _obj = PatchedIssue.parse_obj({
