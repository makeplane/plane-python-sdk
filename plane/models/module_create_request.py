...
class ModuleCreateRequest(BaseModel):
    """
    Serializer for creating modules with member validation and date checking.  Handles module creation including member assignment validation, date range verification, and duplicate name prevention for feature-based project organization setup.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModuleCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModuleCreateRequest:
        """Create an instance of ModuleCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModuleCreateRequest.parse_obj(obj)

        _obj = ModuleCreateRequest.parse_obj({
            "name": obj.get("name"),
