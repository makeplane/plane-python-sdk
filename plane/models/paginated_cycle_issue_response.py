...
class PaginatedCycleIssueResponse(BaseModel):
    """
    ...
    results: conlist(CycleIssue) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedCycleIssueResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedCycleIssueResponse:
        """Create an instance of PaginatedCycleIssueResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedCycleIssueResponse.parse_obj(obj)

        _obj = PaginatedCycleIssueResponse.parse_obj({
            ...
            "results": [CycleIssue.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
