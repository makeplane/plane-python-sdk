...
class IssueLink(BaseModel):
    """
    Full serializer for work item external links.  Provides complete link information including metadata and timestamps for managing external resource associations with work items.  # noqa: E501
    """
    ...
    __properties = ["id", "created_at", "updated_at", "deleted_at", "title", "url", "metadata", "created_by", "updated_by", "project", "workspace", "issue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssueLink:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssueLink:
        """Create an instance of IssueLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssueLink.parse_obj(obj)

        _obj = IssueLink.parse_obj({
            "id": obj.get("id"),
