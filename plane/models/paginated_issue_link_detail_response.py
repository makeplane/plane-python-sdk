...
class PaginatedIssueLinkDetailResponse(BaseModel):
    """
    ...
    results: conlist(IssueLink) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedIssueLinkDetailResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedIssueLinkDetailResponse:
        """Create an instance of PaginatedIssueLinkDetailResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedIssueLinkDetailResponse.parse_obj(obj)

        _obj = PaginatedIssueLinkDetailResponse.parse_obj({
            ...
            "results": [IssueLink.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
