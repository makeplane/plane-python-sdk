...
class PaginatedIssueCommentResponse(BaseModel):
    """
    ...
    results: conlist(IssueComment) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedIssueCommentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedIssueCommentResponse:
        """Create an instance of PaginatedIssueCommentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedIssueCommentResponse.parse_obj(obj)

        _obj = PaginatedIssueCommentResponse.parse_obj({
            ...
            "results": [IssueComment.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
