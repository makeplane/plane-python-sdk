...
class PaginatedIssueActivityResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedIssueActivityResponse:
    ...
    def from_dict(cls, obj: dict) -> PaginatedIssueActivityResponse:
        ...
        if not isinstance(obj, dict):
            return PaginatedIssueActivityResponse.parse_obj(obj)

        _obj = PaginatedIssueActivityResponse.parse_obj({
