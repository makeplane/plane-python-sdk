...
class PaginatedLabelResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedLabelResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedLabelResponse:
        """Create an instance of PaginatedLabelResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedLabelResponse.parse_obj(obj)

        _obj = PaginatedLabelResponse.parse_obj({
            ...
            "results": [Label.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
