...
class PaginatedWorkItemResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedWorkItemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedWorkItemResponse:
        """Create an instance of PaginatedWorkItemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedWorkItemResponse.parse_obj(obj)

        _obj = PaginatedWorkItemResponse.parse_obj({
