...
EntityTypeEnum = Literal["USER_AVATAR", "USER_COVER"]
GroupEnum = Literal[
    "backlog",
    "unstarted",
    "started",
...
PageCreateAPIAccessEnum = int
PriorityEnum = Literal["urgent", "high", "medium", "low", "none"]
PropertyTypeEnum = Literal[
    "TEXT",
    "DATETIME",
    "DECIMAL",
    "BOOLEAN",
...
# Some enums were previously typed as int in schemas; keep consistent simple aliases here
TimezoneEnum = Literal[
    "Africa/Abidjan",
    "Africa/Accra",
    "Africa/Addis_Ababa",
    "Africa/Algiers",
...
# Simple aliases retained from original schemas types
TypeMimeEnum = Literal["image/jpeg", "image/png", "image/webp", "image/jpg", "image/gif"]
NetworkEnum = int
IntakeWorkItemStatusEnum = int
