...
class PaginatedArchivedCycleResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedArchivedCycleResponse:
    ...
    def from_dict(cls, obj: dict) -> PaginatedArchivedCycleResponse:
        ...
        if not isinstance(obj, dict):
            return PaginatedArchivedCycleResponse.parse_obj(obj)

        _obj = PaginatedArchivedCycleResponse.parse_obj({
            ...
            "results": [Cycle.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
