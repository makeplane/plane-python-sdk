...
class PaginatedStateResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedStateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedStateResponse:
        """Create an instance of PaginatedStateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedStateResponse.parse_obj(obj)

        _obj = PaginatedStateResponse.parse_obj({
            ...
            "results": [State.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
