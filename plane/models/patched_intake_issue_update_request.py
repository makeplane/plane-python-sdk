...
class PatchedIntakeIssueUpdateRequest(BaseModel):
    ...
    __properties = ["status", "snoozed_till", "duplicate_to", "source", "source_email", "issue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedIntakeIssueUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedIntakeIssueUpdateRequest:
        """Create an instance of PatchedIntakeIssueUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedIntakeIssueUpdateRequest.parse_obj(obj)

        _obj = PatchedIntakeIssueUpdateRequest.parse_obj({
