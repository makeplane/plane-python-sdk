...
class GenericAssetUploadRequest(BaseModel):
    """
    Serializer for generic asset upload requests with project association.  Validates metadata for generating presigned URLs for workspace assets including project association, external system tracking, and file validation for document management and content storage workflows.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenericAssetUploadRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenericAssetUploadRequest:
        """Create an instance of GenericAssetUploadRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenericAssetUploadRequest.parse_obj(obj)

        _obj = GenericAssetUploadRequest.parse_obj({
            "name": obj.get("name"),
            "type": obj.get("type"),
            "size": obj.get("size"),
