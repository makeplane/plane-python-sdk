...
class PaginatedArchivedModuleResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedArchivedModuleResponse:
    ...
    def from_dict(cls, obj: dict) -> PaginatedArchivedModuleResponse:
        ...
        if not isinstance(obj, dict):
            return PaginatedArchivedModuleResponse.parse_obj(obj)

        _obj = PaginatedArchivedModuleResponse.parse_obj({
            ...
            "results": [Module.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
