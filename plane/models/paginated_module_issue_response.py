...
class PaginatedModuleIssueResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedModuleIssueResponse:
    ...
    def from_dict(cls, obj: dict) -> PaginatedModuleIssueResponse:
        ...
        if not isinstance(obj, dict):
            return PaginatedModuleIssueResponse.parse_obj(obj)

        _obj = PaginatedModuleIssueResponse.parse_obj({
            ...
            "results": [Issue.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
