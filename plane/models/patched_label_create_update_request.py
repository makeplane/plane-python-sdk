...
class PatchedLabelCreateUpdateRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedLabelCreateUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedLabelCreateUpdateRequest:
        """Create an instance of PatchedLabelCreateUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedLabelCreateUpdateRequest.parse_obj(obj)

        _obj = PatchedLabelCreateUpdateRequest.parse_obj({
            "name": obj.get("name"),
            "color": obj.get("color"),
