...
class PatchedAssetUpdate(BaseModel):
    """
    Serializer for asset update requests after upload  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedAssetUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedAssetUpdate:
        """Create an instance of PatchedAssetUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedAssetUpdate.parse_obj(obj)

        _obj = PatchedAssetUpdate.parse_obj({
