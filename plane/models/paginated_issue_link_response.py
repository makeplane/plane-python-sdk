...
class PaginatedIssueLinkResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedIssueLinkResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedIssueLinkResponse:
        """Create an instance of PaginatedIssueLinkResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedIssueLinkResponse.parse_obj(obj)

        _obj = PaginatedIssueLinkResponse.parse_obj({
