...
class PatchedIssueWorkLogAPIRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedIssueWorkLogAPIRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedIssueWorkLogAPIRequest:
        """Create an instance of PatchedIssueWorkLogAPIRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedIssueWorkLogAPIRequest.parse_obj(obj)

        _obj = PatchedIssueWorkLogAPIRequest.parse_obj({
