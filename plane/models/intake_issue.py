...
class IntakeIssue(BaseModel):
    ...
    status: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = Field(default=None, description="* `-2` - Pending * `-1` - Rejected * `0` - Snoozed * `1` - Accepted * `2` - Duplicate")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (-2, -1, 0, 1, 2,):
            raise ValueError("must be one of enum values (-2, -1, 0, 1, 2)")
        return value
