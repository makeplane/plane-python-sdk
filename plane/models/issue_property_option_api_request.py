...
class IssuePropertyOptionAPIRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssuePropertyOptionAPIRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssuePropertyOptionAPIRequest:
        """Create an instance of IssuePropertyOptionAPIRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssuePropertyOptionAPIRequest.parse_obj(obj)

        _obj = IssuePropertyOptionAPIRequest.parse_obj({
            "name": obj.get("name"),
