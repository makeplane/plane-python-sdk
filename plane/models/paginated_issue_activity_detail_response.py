...
class PaginatedIssueActivityDetailResponse(BaseModel):
    """
    ...
    results: conlist(IssueActivity) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedIssueActivityDetailResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedIssueActivityDetailResponse:
        """Create an instance of PaginatedIssueActivityDetailResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedIssueActivityDetailResponse.parse_obj(obj)

        _obj = PaginatedIssueActivityDetailResponse.parse_obj({
            ...
            "results": [IssueActivity.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
