...
class IssuePropertyAPIRequest(BaseModel):
    """
    IssuePropertyAPIRequest
    """
    relation_type: Optional[RelationTypeEnum] = None
    display_name: constr(strict=True, max_length=255, min_length=1) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssuePropertyAPIRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssuePropertyAPIRequest:
        """Create an instance of IssuePropertyAPIRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssuePropertyAPIRequest.parse_obj(obj)

        _obj = IssuePropertyAPIRequest.parse_obj({
