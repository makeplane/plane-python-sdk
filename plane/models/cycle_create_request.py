...
class CycleCreateRequest(BaseModel):
    """
    Serializer for creating cycles with timezone handling and date validation.  Manages cycle creation including project timezone conversion, date range validation, and UTC normalization for time-bound iteration planning and sprint management.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CycleCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CycleCreateRequest:
        """Create an instance of CycleCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CycleCreateRequest.parse_obj(obj)

        _obj = CycleCreateRequest.parse_obj({
            "name": obj.get("name"),
